...
public class ScrapePaintingsAction extends AbstractGameAction {
    ...
    public ScrapePaintingsAction(AbstractCreature source, int amount, boolean endTurnDraw) {
    ...
    public ScrapePaintingsAction(AbstractCreature source, int amount) {
                ...
                if (deckSize + discardSize == 0) {
                    ...
                    if (!this.shuffleCheck) {
                        if (this.amount > deckSize) {
                            ...
                            AbstractDungeon.actionManager.addToTop(new ScrapePaintingsAction(AbstractDungeon.player, tmp));
                            AbstractDungeon.actionManager.addToTop(new EmptyDeckShuffleAction());
                            if (deckSize != 0) {
                                AbstractDungeon.actionManager.addToTop(new ScrapePaintingsAction(AbstractDungeon.player, deckSize));
                            }
