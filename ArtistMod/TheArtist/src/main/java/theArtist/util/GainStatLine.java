...
public class GainStatLine extends AbstractGameEffect {
    ...
    public GainStatLine(float x, float y, Color colosr, double initialAngle) {
        this(x, y, colosr, initialAngle, MathUtils.random(20.0F * Settings.scale, 40.0F * Settings.scale), 0.5F);
    }

    public GainStatLine(float x, float y, Color colosr, double initialAngle, float speed, float duration) {
